...
[ESLint-中国](http://eslint.org/)
[ESLint](http://eslint.org/)

**还有一些eslint-loader配置  查看webpack的笔记吧**
...
- JSON - 用于.eslintrc.json定义配置结构。ESLint的JSON文件也允许JavaScript风格的评论。
- 弃用 - 使用.eslintrc，可以是JSON或YAML。
- package.json - eslintConfig在你的package.json文件中创建一个属性并在那里定义你的配置。
...
# 
[运用 "eslint:recommended"](https://eslint.org/docs/3.0.0/user-guide/configuring#using-eslintrecommended)
